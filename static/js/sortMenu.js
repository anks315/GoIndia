function showSortMenuMain(){
	...
	var modeMenuMain = "" + "<ul class='nav nav-tabs'><li class='active' id ='busDataHead'><a data-toggle='tab'  href='#busData' >&nbsp;&nbsp<img src='/images/bus.png'/>&nbsp;&nbsp</a></li><li id ='trainDataHead'><a data-toggle='tab' href='#trainData'>&nbsp;&nbsp<img src='/images/train.png'/>&nbsp;&nbsp</a></li><li id ='flightDataHead'><a data-toggle='tab' href='#flightData'>&nbsp;&nbsp<img src='/images/flight.png'/>&nbsp;&nbsp</a></li><li id='replan'><a href='#'>Replan</a></li></ul><div class='tab-content'><div class='tab-pane fade in active' id='busData'></div><div class='tab-pane fade' id='flightData'></div><div class='tab-pane fade' id='trainData' id='trainData'></div>"
