...
function showSummary(options){
	...
	for (i = 0; i < options.length; i++) { 
		...
		widlist = widlist + "<tr><td   style = \"text-align: center;white-space: nowrap\"><font color=\""+priceColor+"\">&#8377 "+options[i][0].full[0].price+"/-&nbsp;&nbsp</font></td><td><table width = \"100%\"><tr>"+wid+"</tr></table></td><td  style = \"text-align: center;white-space: nowrap\"><font color=\""+durationColor+"\">&nbsp;&nbsp"+options[i][0].full[0].duration+" Hr</font></td></tr>";
	}
